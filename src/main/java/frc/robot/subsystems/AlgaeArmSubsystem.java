...
public class AlgaeArmSubsystem extends SubsystemBase
{
  ...
  public boolean algaeLoaded()
  {
    ...
    {
      return measurement.distance_mm < 140 && measurement.distance_mm > 60;
    }
    return false;
  }
  ...
  public Command hold()
  {
    return startRun(() -> {
      ...
      reachSetpoint(MathUtil.clamp(angleHold, AlgaeArmConstants.kAlgaeArmMinAngle.in(Degrees),AlgaeArmConstants.kAlgaeArmMaxAngle.in(Degrees)));
    });
  }
